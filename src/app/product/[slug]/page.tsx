        ...
        <div className="min-h-screen pt-32 px-6 max-w-7xl mx-auto flex flex-col md:flex-row gap-12 lg:gap-24 mb-24">
            ...
            <div className="w-full md:w-1/2 flex flex-col max-w-md">
                ...
                {product.sizes.length > 0 && (
                    <div className="mb-12">
                        <span className="text-[10px] text-[var(--muted)] tracking-widest uppercase block mb-2 font-medium">TALLA</span>
                        <div className="flex gap-2">
                            {product.sizes.map(size => (
                                <span key={size} className="border border-[var(--border)] px-4 py-1.5 text-xs text-[var(--foreground)] hover:border-[var(--primary)] transition-colors cursor-default">
                                    {size}
                                </span>
                            ))}
                        </div>
